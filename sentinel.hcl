########################################################################################################
# CIS Compute checks
# Details on the checks can be found at:
# https://github.com/hashicorp/terraform-foundational-policies-library/tree/master/cis/gcp/compute
########################################################################################################
...
# CIS DB checks
# Details on the checks can be found at:
# https://github.com/hashicorp/terraform-foundational-policies-library/tree/master/cis/gcp/databases
########################################################################################################
...
########################################################################################################
# CIS Networking checks
# Details on the checks can be found at:
# https://github.com/hashicorp/terraform-foundational-policies-library/tree/master/cis/gcp/networking
########################################################################################################
...
# CIS Storage checks
# Details on the checks can be found at:
# https://github.com/hashicorp/terraform-foundational-policies-library/tree/master/cis/gcp/storage
########################################################################################################
